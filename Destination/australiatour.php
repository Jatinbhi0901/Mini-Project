...
<head>
    ...
    <link rel="stylesheet" href="../css/australiatour.css">
...
<body>
    ...
    <section class="section1">
        <div class="container1">
            <h3 class="hea1">Amazing Holidays to Australia</h3>
            <h1 class="hea2">Australia Tour Packages</h1>
        </div>
    </section>
    ...
    <section class="section2">
        <div class="box">
            <h2 class="overview">Why Book Australia Tours with Us?</h2>
            <p>
    ...
    <section class="section3">
        <h1 class="title2">Popular Australia Holiday Packages</h1>
        <br>

        <div class="row">
            <div>
                <a href="../Destination/australia1.php"><img src="../images/australia/a2.jpg" alt="" width="350px"
                        height="200px"></a>
                <h3 class="heading">Sydney City Break</h3>
            </div>

            <div>
                <a href="../Destination/australia2.php"><img src="../images/australia/a5.jpg" alt="" width="350px"
                        height="200px"></a>
                <h3 class="heading">Gold Coast Free & Easy</h3>
            </div>
        </div>
