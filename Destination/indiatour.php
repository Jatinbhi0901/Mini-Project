...
<head>
    ...
    <link rel="stylesheet" href="../css/indiatour.css">
...
<body>
    ...
    <section class="section1">
        <div class="container1">
            <h3 class="hea1">Amazing Holidays to India</h3>
            <h1 class="hea2">India Tour Packages</h1>
        </div>
    </section>
    ...
    <section class="section3">
        <h1 class="title2">Popular India Holiday Packages</h1>
        <br>

        <div class="row">
            <div>
                <a href="../Destination/kashmir.php"><img src="../images/kash/k2.jpg" alt="" width="350px"
                        height="200px"></a>
                <h3 class="heading">Best of Kashmir</h3>
            </div>

            <div>
                <a href="../Destination/maldives.php"><img src="../images/mal/mal2.jpeg" alt="" width="350px"
                        height="200px"></a>
                <h3 class="heading">Maldives Exploration</h3>
            </div>
        </div>
